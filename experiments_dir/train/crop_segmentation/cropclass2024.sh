...
mkdir data
gsutil -m cp -r gs://instageo/data/multitemporal-crop-segmentation-US-CDL-2024/* data/
...
gsutil -m cp -r instageo_exp gs://instageo/model/multitemporal_crop_segmentation-US-CDL-2024
